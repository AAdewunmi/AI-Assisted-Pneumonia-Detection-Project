...
def build_resnet50_baseline(num_classes: int = 2) -> nn.Module:
    """Return a pretrained ResNet-50 with a custom classification head."""
...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument(
            "--img_dir",
            type=str,
            default="data/rsna_subset/train_images",
        )
